  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col justify-center items-center py-12 px-4">
      <motion.div 
        ...
        className="bg-gray-900 border border-indigo-900 shadow-2xl rounded-2xl p-10 text-center max-w-md w-full relative overflow-hidden"
      >
        <div className="absolute top-0 left-0 w-full h-2 bg-indigo-500" />
        
        <div className="w-20 h-20 bg-indigo-900/50 rounded-full flex items-center justify-center mx-auto mb-6 border border-indigo-500/30">
          <Clock className="text-indigo-400 w-10 h-10 animate-pulse" />
        </div>
        
        <h1 className="text-3xl font-bold text-white mb-4">Under Review</h1>
        
        <p className="text-gray-400 mb-8 leading-relaxed">
          Your center application has been received and is currently under review by our administrative team. 
          We typically process applications within <span className="text-indigo-400 font-medium">1-2 business days</span>.
        </p>
        ...
        <div className="bg-gray-950 rounded-xl p-4 mb-8 border border-gray-800 text-left">
          ...
          <ul className="space-y-3 relative">
            <li className="flex items-start">
               <div className="w-6 h-6 rounded-full bg-indigo-500/20 flex items-center justify-center mr-3 mt-0.5 z-10">
...
export default CenterPendingPage;
