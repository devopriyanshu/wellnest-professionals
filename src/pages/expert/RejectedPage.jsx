    ...
    <div className="min-h-screen bg-gray-950 flex flex-col justify-center items-center py-12 px-4">
      ...
      >
        ...
        <p className="text-gray-400 mb-8 leading-relaxed">
          ...
          This might be due to missing qualifications, an incomplete profile, or failure to meet our platform standards.
        </p>

        <div className="space-y-4">
          <button
            onClick={() => navigate('/expert/register?reapply=true')}
...
export default ExpertRejectedPage;
